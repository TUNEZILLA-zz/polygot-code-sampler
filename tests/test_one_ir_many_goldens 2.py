...
def test_strategy_selection():
    ...
    test_cases = [
        ...
        },
        {
            ...
            "expected_patterns": [
                "# NOTE: parallelized with thread-local partials",
                "@threads",
                "parts1",
            ],
        },
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        for pattern in test_case["expected_patterns"]:
            assert (
                pattern in output
            ), f"Pattern '{pattern}' not found in output for {test_case['flags']}"
...
def test_dict_comprehension_strategies():
    ...
    test_cases = [
        ...
        },
        {
            "flags": {"mode": "auto", "parallel": True},
            "expected_patterns": [
                "# NOTE: parallelized with shard-merge pattern",
                "dict_comp_parallel",
            ],
        },
    ]
...
def test_fallback_behavior():
    ...
    print(
        "✅ Fallback test passed - non-associative operation correctly falls back to sequential"
    )
