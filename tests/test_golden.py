...
def test_sql_postgresql_golden(python_code, case_name, description, update_golden, golden_dir):
    """Test SQL PostgreSQL dialect cases against golden files"""
    print(f"\n🐘 Testing SQL PostgreSQL {case_name}: {description}")
    print(f"   Python: {python_code.strip()}")

    success = run_case(python_code, f"{case_name}.pg", update_golden, golden_dir, use_sql=True, sql_dialect="postgresql")
    assert success, f"SQL PostgreSQL test case {case_name} failed"


@pytest.mark.parametrize("python_code,case_name,description", SQL_DIALECT_TEST_CASES)
def test_sql_sqlite_golden(python_code, case_name, description, update_golden, golden_dir):
    """Test SQL SQLite dialect cases against golden files"""
    print(f"\n🗃️ Testing SQL SQLite {case_name}: {description}")
    print(f"   Python: {python_code.strip()}")

    success = run_case(python_code, f"{case_name}.sqlite", update_golden, golden_dir, use_sql=True, sql_dialect="sqlite")
...
def test_go_parallel_golden(python_code, case_name, description, update_golden, golden_dir):
    """Test Go parallel cases against golden files"""
    print(f"\n🚀 Testing Go Parallel {case_name}: {description}")
    print(f"   Python: {python_code.strip()}")

    success = run_case(python_code, case_name, update_golden, golden_dir, use_go=True, use_go_parallel=True)
