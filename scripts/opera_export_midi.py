...
def create_voice_notes(voice_name: str, voice_config: Dict[str, Any], act: int = 1) -> List[Dict[str, Any]]:
...
def export_to_midi(voices_data: Dict[str, List[Dict[str, Any]]], bpm: int = 96, output_file: str = "out/opera/opera.mid"):
    ...
    try:
        ...
        for voice_name, notes in voices_data.items():
            ...
            track.append(Message('program_change', program=program_map.get(voice_name, 0), time=0))
...
def create_manifest(voices_data: Dict[str, List[Dict[str, Any]]], seed: str, bpm: int, key: str) -> Dict[str, Any]:
...
def main():
    ...
    parser.add_argument("--voices-file", default="out/opera/voices_data.json", help="Voices data file")
    parser.add_argument("--output", default="out/opera/opera.mid", help="Output MIDI file")
