...
class LOLcatSeedStamp:
    ...
    def demo_seed_stamping(self, text="Seed Stamping Demo"):
        ...
        stamps = [
            {"seed": 42, "preset": "classic", "macro": {"color": 0.0, "space": 0.0, "motion": 0.0, "crunch": 0.0}},
            {"seed": 123, "preset": "stage-punch", "macro": {"color": 0.5, "space": 0.3, "motion": 0.7, "crunch": 0.4}},
            {"seed": 456, "preset": "cat-walk", "macro": {"color": 0.2, "space": 0.1, "motion": 0.1, "crunch": 0.2}}
        ]
    ...
    def test_perfect_rerun(self, text="Perfect Rerun Test"):
        ...
        self.set_stamp(seed=999, preset="classic", macro={"color": 0.5, "space": 0.3, "motion": 0.2, "crunch": 0.1})
        filepath = self.create_artifact(text)
...
def main():
    ...
    if args.demo:
        ...
        print("Usage: python3 lolcat_seed_stamp.py --demo | --test | --create | --recall <file>")
