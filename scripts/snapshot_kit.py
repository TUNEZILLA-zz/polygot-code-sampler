...
class SnapshotKit:
    ...
    def generate_snapshots(
        self, scene_id: str, text: str = "Code Live"
    ) -> Dict[str, str]:
        ...
        for variant, config in self.snapshot_configs.items():
            ...
            html_content = self._generate_snapshot_html(scene_id, variant, text, config)
    ...
    def _generate_snapshot_html(
        self, scene_id: str, variant: str, text: str, config: Dict[str, Any]
    ) -> str:
...
<body>
    ...
    def _generate_manifest(
        self, scene_id: str, snapshots: Dict[str, str]
    ) -> Dict[str, Any]:
    ...
    def generate_all_scenes(
        self, scenes_dir: str = "presets/scenes"
...
Examples:
  ...
  python3 scripts/snapshot_kit.py --scene tour_opener --text "TuneZilla"
    ...
    parser.add_argument(
        "--all-scenes", action="store_true", help="Generate snapshots for all scenes"
    )
    parser.add_argument(
        "--output-dir", default="out/touring/snapshots", help="Output directory"
    )
