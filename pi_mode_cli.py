...
Examples:
  ...
  python pi_mode_cli.py art
    ...
    apply_parser = subparsers.add_parser(
        "apply", help="Apply π mode transformations to code"
    )
    apply_parser.add_argument(
        "--pi-mode", required=True, help="Comma-separated list of π modes"
    )
    ...
    apply_parser.add_argument(
        ...
        type=float,
        default=100.0,
        help="π multiplier for loop length",
    )
    apply_parser.add_argument(
        "--waveform-freq", type=float, default=1.0, help="Waveform frequency"
    )
    apply_parser.add_argument(
        "--fractal-depth", type=int, default=3, help="Fractal recursion depth"
    )
    apply_parser.add_argument(
        "--circular-radius", type=float, default=1.0, help="Circular radius"
    )
    apply_parser.add_argument(
        "--constants-mode", action="store_true", help="Enable mathematical constants"
    )
    apply_parser.add_argument(
        "--easter-egg-mode", action="store_true", help="Enable Pi Day easter eggs"
    )
