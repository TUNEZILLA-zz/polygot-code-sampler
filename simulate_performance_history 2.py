...
def create_simulated_benchmark(
    timestamp: str, base_metrics: dict, variation: float = 0.1
) -> dict:
    ...
    return {
        ...
        "rust_generation": {
            ...
            "avg_parallel_generation_time_ms": simulated_metrics.get(
            ...
            "parallel_generation_times": [
                {
                    "case": "simple_squares",
                    "time_ms": simulated_metrics.get("rust_parallel_time_ms", 0.008)
                    * 1.2,
                    "code_size_chars": 154,
                },
                {
...
def main():
    ...
    for i in range(10):
        ...
        benchmark_data = create_simulated_benchmark(
            timestamp, trended_metrics, variation
        )
    ...
    print(
        "   python3 performance_dashboard.py --files performance_data/benchmark_history_*.json --print"
    )
