...
def lolcat_plus(
    ...
    *,
    ...
    nyan_trail: float = 0.0,
    emoji_palette: str = "default",
    ...
    words = [
        _stretch_vowels(w, intensity * 0.6, seed) if re.match(r"\w", w) else w
        for w in words
    ]

    # 4) chaos case
    words = [
        _chaos_case(w, chaos, seed) if re.match(r"[A-Za-z]", w) else w for w in words
    ]
